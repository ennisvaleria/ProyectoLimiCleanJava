 ...
 * @author valer
 */
public class FrmDetalleProducto extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrmDetalleProducto.class.getName());
    ...
    private void initComponents() {
        ...
        cmbCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Limpieza", "Accesorios", "Protección", "Kits" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FrmDetalleProducto().setVisible(true));
    }
